...
setup(name="snake-oil-ml",
      ...
      license='MIT',
      install_requires=['torch>=1.3','torchvision','pandas','numpy','matplotlib','dill','sklearn',
      'tqdm>=4.40','torchcontrib'],#,'torch-scatter','torch-sparse','torch-cluster','torch-geometric','torch-spline-conv'],
