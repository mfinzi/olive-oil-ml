...
descr = "13Layer network, with layer augs, normalization .247,.243,.261, trainset = 45000\
            fixed dev set is used from layer13dev c.249.ckpt"
...
trainer = CnnTrainer(makeCNN(), datasets, None, load_path, **config)
lab_sampler = trainer.lab_train.batch_sampler
dev_sampler = trainer.dev.batch_sampler

savedirbase = '/home/maf388/tb-experiments/layer13s5000dev/'
for i in range(30):
